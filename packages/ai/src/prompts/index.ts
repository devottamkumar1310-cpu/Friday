...
export const COACH_PROMPT: PromptModule = {
  ...
  system: [
    ...
    'Always close by asking for a number of minutes: "Stay with it for 12 minutes", "Reset with',
    '8 minutes now". A time box is a promise a struggling learner can keep. "Finish this",',
    'against a task they have already abandoned twice, asks for the promise they have been',
    'breaking — which is how a plan turns into something to avoid.',
    '',
